...
BEFORE:
src/rules/class-name.js - fold fix: (fixer)
...
Вернув объект с именами типов синтаксического дерева.
Этим мы говорим что estraverse если встретишь объекта типа ClassDeclaration то вызови эту функцию
будет передан этот элемемент дерева как параметр в эту функцию.
Паттерн visitor.
Посмотрим пример.
...
Мы можем найти Identifier, и проверить родительский элемент.
А может найти ClassDeclaration и проверить свойство id.
---
...
имя теста, как правило это имя правила, само правило - его реализацию, и варианты кода с правильной и неправильной реализацией,
