...
Как это сделать?
Надо из этой функции вернуть обект ключи у которого будут имена типов.
Когда estravese будет обходить дерево, он видит вот объект у которого есть, свойства
